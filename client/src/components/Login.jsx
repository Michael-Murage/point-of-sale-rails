	...
	return (
		<div className="vh-100 gradient-custom row">
			<div className='col col-md-4 col-lg-4 col-sm-0'>
				<img src={'/assets/coffee_with_friends.png'} alt='friends with coffee' className='login-img'/>
			</div>
				<form className='col col-md-8 col-lg-8 col-sm-12 login-form text-center bg-light pt-3 border align-self-center' onSubmit={handleSubmit}>
